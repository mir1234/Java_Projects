...
public class q7 implements ActionListener
{
    ...
    q7(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q7</font>) Which operator precedence is lower then other?</h2></html>");
        jp2.add(jl2);

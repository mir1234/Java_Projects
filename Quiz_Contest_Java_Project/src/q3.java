...
public class q3 implements ActionListener
{
    ...
    q3(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q3</font>) What is the default value of the local variables?</h2></html>");
        jp2.add(jl2);

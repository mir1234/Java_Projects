...
public class q9 implements ActionListener
{
    JFrame jfm1;
    ...
    q9(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q9</font>) Interface is a class like constructor that contains -</h2></html>");
        jp2.add(jl2);
        ...
        //Adding option
        op1=new JRadioButton("constants");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op2=new JRadioButton("static data");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op3=new JRadioButton("easy methods");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op4=new JRadioButton("none of them");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==b1 && (op1.isSelected()==true || op2.isSelected()==true || op3.isSelected()==true || op4.isSelected()==true))
        {
            ...
            if(op1.isSelected()==true)
                ...
                score1=score1+0;
            timer.cancel();
            q10 ob=new q10(name1,score1,arr);

...
public class q1 implements ActionListener
{
    ...
    q1(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q1</font>) Which of the following is not a java keyword?</h2></html>");
        jp2.add(jl2);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==b1 && (op1.isSelected()==true || op2.isSelected()==true || op3.isSelected()==true || op4.isSelected()==true))
        {
            ...
            if(op3.isSelected()==true)
                ...
                score1=score1+0;
            q2 ob1=new q2(name1,score1,arr);
            timer.cancel();
        }
    }

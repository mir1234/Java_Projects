...
public class q6 implements ActionListener
{
    ...
    q6(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q6</font>) In a Non-sub class in other package which access is allow?</h2></html>");
        jp2.add(jl2);
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op3=new JRadioButton("Protected");

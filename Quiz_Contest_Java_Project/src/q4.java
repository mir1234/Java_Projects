...
public class q4 implements ActionListener
{
    ...
    q4(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q4</font>) Following code will result in: int a1=5; doublea2=(float)a1;?</h2></html>");
        jp2.add(jl2);
        ...
        //Adding option
        op1=new JRadioButton("Syntax error");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op2=new JRadioButton("No errors");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op3=new JRadioButton("Exception");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op4=new JRadioButton("Runtime error");

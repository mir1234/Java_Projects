...
public class q5 implements ActionListener
{
    ...
    q5(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q5</font>) '^' symbol is in which operator?</h2></html>");
        jp2.add(jl2);
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op3=new JRadioButton("Arithmetic");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op4=new JRadioButton("Relational");

...
public class q8 implements ActionListener
{
    ...
    q8(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q8</font>) Java support polymorphism in Method -</h2></html>");
        jp2.add(jl2);
        ...
        //Adding option
        op1=new JRadioButton("Inheritance");

...
public class q2 implements ActionListener
{
    ...
    q2(String name2,int score2,ArrayList rarr)
    {
        arr=rarr;
        name1=name2;
        score1=score2;
        ...
        //Question
        jl2=new JLabel("<html><h2 style=\"margin-left:20px;\"><font color=\"blue\">Q2</font>) Which is NOT a section of all types of loop?</h2></html>");
        jp2.add(jl2);
        ...
        //Adding option
        op1=new JRadioButton("initialization");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op2=new JRadioButton("loop body");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op3=new JRadioButton("test statement");
        ...
        jp4.add(jl2);
        jp5.add(jp4);
        op4=new JRadioButton("word \"while\"");
